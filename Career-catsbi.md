...
- Spring Boot 역량: Spring Boot의 라이프 사이클을 이해하고 있으며, 순수 자바로만 가지고 스프링 프레임워크를 제한적으로 구현할 수 있으나, 스프링 부트의 다양한 기능을 활용하지 못하며 스프링 진영의 다양한 프로젝트들을 활용하지 못함.
...
### To-Do List
- Kotlin 학습 심화: 코틀린만의 문법이나 코루틴과 같은 기술들에 대한 학습 및 기존 기능에 도입하여 사용해본다.
- Spring Boot 역량: Spring 진영에서 사용해보지 않은 프로젝트들을 사용해보고, 스프링 부트의 다양한 기능들을 활용해본다.
...
- Docker 역량 : 복잡한 환경에서의 운영 경험을 쌓기 위해 복잡한 환경을 구축하고 운영해본다.
- 데이터 제어및 관리 역량
...
- 시스템 안정성이 높은 아키택쳐 구성
  - Traffic 처리 : Circuit break, A/B Test, Traffic control: 각각의 기능을 학습하고, 실제로 적용해본다.
  - 데이터 모니터링 능력 : Prometheus와 Grafana를 이용해 모니터링을 해본다.
